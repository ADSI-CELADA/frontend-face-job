...
if (infoUserC!=null ) {
    const result=await getCommentsUsersText(context.idComment)
...
async function sendComment() {
    ...
    if (context.idComment!=null || commentUser!=undefined) {
       ...
       const result=await insertCommentText(context.idComment,formdata)
       console.log(result);
       setChanges("cambio")
...
async function deleteComment() {
  if (infoComment!=0) {
   ...
   const result=await deleteCommentsText(infoComment,formdata)
    console.log(result);
